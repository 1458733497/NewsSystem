...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/gym/Public/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/gym/Public/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/gym/Public/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/gym/Public/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/gym/Public/css/sing/common.css" />
    <link rel="stylesheet" href="/gym/Public/css/party/bootstrap-switch.css" />
    <link rel="stylesheet" type="text/css" href="/gym/Public/css/party/uploadify.css">

    <!-- jQuery -->
    <script src="/gym/Public/js/jquery.js"></script>
    <script src="/gym/Public/js/bootstrap.min.js"></script>
    <script src="/gym/Public/js/dialog/layer.js"></script>
    <script src="/gym/Public/js/dialog.js"></script>
    <script type="text/javascript" src="/gym/Public/js/party/jquery.uploadify.js"></script>
  ...
  <ul class="nav navbar-right top-nav">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li>
          <a href="/gym/admin.php?c=admin&a=personal"><i class="fa fa-fw fa-user"></i> 个人中心</a>
        </li>
       
        <li class="divider"></li>
        <li>
          <a href="/gym/admin.php?c=login&a=loginout"><i class="fa fa-fw fa-power-off"></i> 退出</a>
        </li>
      </ul>
    </li>
  </ul>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav nav_list">
      <li <?php echo (getActive($index)); ?>>
        <a href="/gym/admin.php"><i class="fa fa-fw fa-dashboard"></i> 首页</a>
      </li>
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/gym/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
      ...
      <div class="row">
        <form action="/gym/admin.php" method="get">
          <div class="col-md-3">
...
<script>
  var SCOPE = {
    'edit_url' : '/gym/admin.php?c=content&a=edit',
    'add_url' : '/gym/admin.php?c=content&a=add',
    'set_status_url' : '/gym/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/index.php?c=view',
    'listorder_url' : '/gym/admin.php?c=content&a=listorder',
    'push_url' : '/gym/admin.php?c=content&a=push',
  }
</script>
<script src="/gym/Public/js/admin/common.js"></script>
